...
def treeinfo_attributes_tree(tree_file):
    """
    Extracts per-tree attributes from a tree file generated using treeinfo.
    ...
    Returns:
    pandas.DataFrame: A DataFrame containing tree attributes.
        If the input file is a forest, includes a 'tree_id' column.
    """
    line_list = []
...
def treeinfo_attributes_segment(tree_file):
    """
    Extracts per-segment attributes from a tree file generated using treeinfo.
    Can be run on a 'forest' or single treefile.
    ...
    Returns:
    pandas.DataFrame: A DataFrame containing segment attributes.
        If the input file is a forest, includes a 'tree_id' column.
    """
    line_list = []
    tree_ids = []
...
def attributes_tree(tree_file):
    """
    Extracts per-tree attributes from a tree file generated using rayextract trees.
    Can be run on a 'forest' or single treefile.
